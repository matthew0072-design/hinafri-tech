    ...
    return (
        <div className='flex flex-col items-start text-white bg-[#30B666]    '>
            ...
            <div className='flex flex-col gap-8 md:gap-12 p-8 md:items-center  md:justify-center lg:justify-around   lg:gap-36 w-full lg:flex-row'>
                ...
                <div>
                    <Link href="/" className='bg-[#06030B] border md:px-8 md:py-3 md:h-[89px] md:bg-white md:text-[#30B666] md:border-white text-sm border-[#06030B] md:text-2xl outline-none font-bold font-heebo rounded-tl-[24px] rounded-br-[24px] '>Get started</Link>
                </div>
            </div>         
